...
export const roles = [
  ...
  },
  {
    ...
    users: 4,
    desc: "Ventes, clients, factures",
    couleur: "info",
  },
  {
    nom: "Comptable",
    users: 3,
    desc: "Factures, paiements, rapports",
    couleur: "success",
  },
  {
    nom: "Magasinier",
    users: 5,
    desc: "Stocks, mouvements, inventaires",
    couleur: "warning",
  },
  {
    nom: "Acheteur",
...
export const notifications = [
  {
    ...
    texte: "FAC-2026-146 — InfoCorp (980 f) a dépassé son échéance.",
    temps: "Il y a 12 min",
    lu: false,
  },
  {
    type: "warning",
    titre: "Stock faible",
    texte: '« Écran 27" 4K » est passé sous le seuil minimum (5 unités).',
    temps: "Il y a 40 min",
    lu: false,
  },
  {
    ...
    titre: "Prévision IA",
    texte:
      "Pic de demande attendu sur « Casque sans fil ANC » la semaine prochaine.",
    temps: "Il y a 1 h",
    lu: false,
  },
  {
    type: "success",
    titre: "Paiement reçu",
    texte: "TechnoPlus SARL a réglé 4 280 f par virement.",
    temps: "Il y a 2 h",
    lu: true,
  },
  {
    ...
    texte: "Digital Store a passé la commande VTE-2047.",
    temps: "Il y a 3 h",
    lu: true,
  },
  {
    ...
    texte: "Routeur Wi-Fi 6 en rupture de stock.",
    temps: "Hier",
    lu: true,
  },
];
