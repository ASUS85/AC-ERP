...
export const CURRENCY_STORAGE_KEY = "erp_currency";
...
export function getCurrencyMeta(code?: string | null): AfricanCurrency {
...
export function setStoredCurrency(code?: string | null): string {
  const normalized = normalizeCurrencyCode(code);
...
export function formatCurrency(
  ...
  const code = normalizeCurrencyCode(currencyCode || getStoredCurrency());
  try {
