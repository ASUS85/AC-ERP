...
const cols: Column<P>[] = [
  {
    key: "ref",
    header: "Référence",
    render: (p) => <span className="font-medium text-foreground">{p.ref}</span>,
  },
  ...
  },
  {
    ...
    render: (p) => (
      <span
        className={cn(
          "font-medium",
          p.type === "Reçu" ? "text-success" : "text-info",
        )}
      >
...
function PaymentsPage() {
  return (
    <>
      <PageHeader
        title="Paiements"
        description="Paiements reçus, paiements effectués et reçus"
