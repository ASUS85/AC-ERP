...
import { S as StatCard, a as SectionCard, b as SearchableSelect, P as Pagination } from "./widgets-BIAbd_8_.js";
...
import { g as getClients, a as getClientsPdf, u as updateClient, c as createClient, d as deleteClient } from "./clients.service-BDqAZBtg.js";
...
function CustomersPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editingClient ? "Modifier un client" : "Ajouter un client", description: "Renseignez les informations du client.", size: "xl", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Field, { label: "Plafond crédit", htmlFor: "plafond", error: errors.plafondCredit, children: /* @__PURE__ */ jsx(Input, { id: "plafond", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.plafondCredit || "")), onChange: (e) => setField("plafondCredit", Number(normalizeNumberInput(e.target.value)) || 0), placeholder: "0" }) }),
      /* @__PURE__ */ jsx(Field, { label: "Délai paiement (jours)", htmlFor: "delai", error: errors.delaiPaiement, children: /* @__PURE__ */ jsx(Input, { id: "delai", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.delaiPaiement || "")), onChange: (e) => setField("delaiPaiement", Number(normalizeNumberInput(e.target.value)) || 0), placeholder: "30" }) }),
