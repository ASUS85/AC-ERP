...
import { u as useDashboardStore, a as getTopClients, E as EMPTY_DASHBOARD_OVERVIEW } from "./dashboard.store-ClVeRAgC.js";
import { i as api } from "./router-DPN3mKuc.js";
import "@tanstack/react-router";
import "./input-DWqQzZ0E.js";
...
function StatsPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "CA mensuel", description: "Chiffre d'affaires", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(AreaChart, { data: monthlyData, margin: {
        left: -10,
        right: 8
      }, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Achats mensuels", description: "Dépenses fournisseurs", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: monthlyData, margin: {
        left: -10,
        right: 8
      }, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: grid, vertical: false }),
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Marge mensuelle", description: "Ventes moins achats", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: monthlyData, margin: {
        left: -10,
        right: 8
      }, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: grid, vertical: false }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "Ventes vs achats", description: "Comparatif mensuel", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-80", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(ComposedChart, { data: monthlyData, margin: {
        left: -10,
        right: 8
      }, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: grid, vertical: false }),
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Structure financière", description: "CA, achats, marge et paiements", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-80", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: financeStructure, margin: {
        left: -10,
        right: 8
      }, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: grid, vertical: false }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "Top produits", description: "Unités vendues", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: topProducts, layout: "vertical", margin: {
        left: 32,
        right: 16
      }, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Top clients", description: "Chiffre d'affaires", children: /* @__PURE__ */ jsx(ChartFrame, { loading: chartLoading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: topClients, layout: "vertical", margin: {
        left: 32,
        right: 16
      }, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: grid, horizontal: false }),
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Répartition des stocks", description: "Par catégorie", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(PieChart, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(SectionCard, { title: "Historique journalier de l'activité", description: "Ventes, achats, marge et paiements sur longue période", children: /* @__PURE__ */ jsx(ChartFrame, { loading: chartLoading, className: "h-[520px]", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(ComposedChart, { data: dailyData, margin: {
      left: -10,
      right: 20,
      top: 10,
      bottom: 5
