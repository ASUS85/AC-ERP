...
import { f as fmtCurrency, s as suppliers } from "./erp-data-DdbAvP8x.js";
...
function SuppliersPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsx(StatCard, { label: "Volume d'achats", value: fmtCurrency(555600), sub: "cumulé", icon: /* @__PURE__ */ jsx(Package, { className: "h-5 w-5" }) }),
