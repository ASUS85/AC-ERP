...
function AppModal({
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsx(DialogContent, { className: cn("max-h-[90vh] overflow-hidden p-0", sizeClasses[size], positionClasses[position]), children: /* @__PURE__ */ jsxs("div", { className: "flex max-h-[90vh] flex-col", children: [
