...
import { ArrowDownToLine, ClipboardList, Warehouse, ArrowUpFromLine, AlertTriangle, Loader2, Eye, CheckCircle2, Ban, RefreshCw, Save, XCircle, AlertCircle } from "lucide-react";
    ...
    try {
      const [skRes, mvRes, alRes, invRes, prodRes] = await Promise.allSettled([
        ...
        (async () => {
          const {
            default: api2
          } = await import("./router-CpiKU9_2.js").then((n) => n.s);
