    ...
    DialogContent,
    {
      onPointerDownOutside: (e) => {
        if (!closeOnOutsideClick) {
          ...
          const isPopper = target.closest("[data-radix-popper-content-wrapper]");
          const isListbox = target.closest('[role="listbox"]');
          const isDropdown = target.closest("[data-searchable-dropdown]");
          if (!isPopper && !isListbox && !isDropdown) {
            e.preventDefault();
          }
        }
      },
