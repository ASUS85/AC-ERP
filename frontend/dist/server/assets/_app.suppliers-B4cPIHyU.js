...
import { c as suppliers, f as fmtCurrency } from "./erp-data-DbNh89rB.js";
...
function SuppliersPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsx(StatCard, { label: "Volume d'achats", value: "555 600 f", sub: "cumulé", icon: /* @__PURE__ */ jsx(Package, { className: "h-5 w-5" }) }),
