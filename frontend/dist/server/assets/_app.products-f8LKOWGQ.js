...
import { Loader2, Eye, Download, Package, Pencil, Trash2 } from "lucide-react";
import { P as PageHeader } from "./PageHeader-Dn6TWXax.js";
import { S as StatCard, a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-BIAbd_8_.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DiuCO5_I.js";
import { toast } from "sonner";
import { f as fmtCurrency, b as fmtNumber } from "./erp-data-Byxy0z8s.js";
import { g as getCategories } from "./categories.service-CR5gl_Pw.js";
import { g as getProduits, a as getProduitsPdf, u as uploadProduitPhoto, b as updateProduit, c as createProduit, d as archiveProduit } from "./produits.service-TceHzn1I.js";
import { n as normalizeNumberInput, f as formatGroupedInputNumber } from "./number-input-BgmEQ3sF.js";
import "@tanstack/react-router";
import "./router-qTiJlct9.js";
...
function ProductsPage() {
  ...
  const cols = [{
    ...
    render: (product) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx("span", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10 text-primary", children: product.photo ? /* @__PURE__ */ jsx("img", { src: product.photo, alt: product.designation, className: "h-full w-full rounded-lg object-cover" }) : /* @__PURE__ */ jsx(Package, { className: "h-4 w-4" }) }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Produits", description: "Catalogue et gestion des articles", breadcrumb: ["Gestion commerciale", "Produits"], actions: /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", onClick: () => void exportProducts(), disabled: exporting, children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editingProduct ? "Modifier un produit" : "Ajouter un produit", description: "Renseignez les informations du catalogue.", size: "xl", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Field, { label: "Image produit", htmlFor: "photo", error: errors.photo, children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        form.photo ? /* @__PURE__ */ jsx("div", { className: "rounded-md border border-border p-2", children: /* @__PURE__ */ jsx("img", { src: form.photo, alt: "Aperçu produit", className: "h-24 w-24 rounded object-cover" }) }) : null
      ] }) }),
      ...
      /* @__PURE__ */ jsx(Field, { label: "Prix d’achat HT", htmlFor: "prixAchatHt", error: errors.prixAchatHt, children: /* @__PURE__ */ jsx(Input, { id: "prixAchatHt", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.prixAchatHt || "")), onChange: (e) => setField("prixAchatHt", Number(normalizeNumberInput(e.target.value)) || 0), placeholder: "Entrez un prix de d'achat" }) }),
      /* @__PURE__ */ jsxs(Field, { label: "Prix de vente HT", htmlFor: "prixVenteHt", error: errors.prixVenteHt, children: [
        /* @__PURE__ */ jsx("span", { class: "ml-1 text-destructive", children: "*" }),
        /* @__PURE__ */ jsx(Input, { id: "prixVenteHt", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.prixVenteHt || "")), onChange: (e) => setField("prixVenteHt", Number(normalizeNumberInput(e.target.value)) || 0), placeholder: "Entrez un prix de vente" })
      ] }),
      /* @__PURE__ */ jsxs(Field, { label: "Taux TVA (%)", htmlFor: "tauxTva", error: errors.tauxTva, children: [
        /* @__PURE__ */ jsx("span", { class: "ml-1 text-destructive", children: "*" }),
        /* @__PURE__ */ jsx(Input, { id: "tauxTva", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.tauxTva || "")), onChange: (e) => setField("tauxTva", Number(normalizeNumberInput(e.target.value)) || 0), placeholder: "Entrez la TVA(%)" })
      ] }),
      /* @__PURE__ */ jsxs(Field, { label: "Stock minimum", htmlFor: "stockMinimum", error: errors.stockMinimum, children: [
        /* @__PURE__ */ jsx("span", { class: "ml-1 text-destructive", children: "*" }),
        /* @__PURE__ */ jsx(Input, { id: "stockMinimum", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.stockMinimum || "")), onChange: (e) => setField("stockMinimum", Number(normalizeNumberInput(e.target.value)) || 0), placeholder: "Entrez le stock minimum" })
      ] }),
      !editingProduct ? /* @__PURE__ */ jsx(Field, { label: "Stock initial", htmlFor: "stockInitial", error: errors.stockInitial, children: /* @__PURE__ */ jsx(Input, { id: "stockInitial", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.stockInitial || "")), onChange: (e) => setField("stockInitial", Number(normalizeNumberInput(e.target.value)) || 0), placeholder: "Entrez le stock initial" }) }) : null,
