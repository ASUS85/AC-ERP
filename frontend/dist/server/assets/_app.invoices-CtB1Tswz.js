...
import { S as StatCard, a as SectionCard, T as Toolbar, P as Pagination } from "./widgets-VozA-0is.js";
...
import { o as invoices, f as fmtCurrency } from "./erp-data-CgsBYils.js";
...
function InvoicesPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsx(StatCard, { label: "Total facturé", value: "284 750 €", sub: "ce mois", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "Payées", value: "248 100 €", sub: "encaissées", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "En attente", value: "18 230 €", sub: "à venir", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "En retard", value: "18 420 €", sub: "5 factures", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) })
    ] }),
