...
import { a as SectionCard } from "./widgets-BIAbd_8_.js";
import { B as Button } from "./input-CXzFZCFy.js";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-CQEj5IEe.js";
import { g as getNotifications, a as marquerToutesLues, m as marquerLue } from "./notifications.service-CcQtu0QA.js";
import { c as cn } from "./router-qTiJlct9.js";
...
function NotificationsPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Centre de notifications", description: "Alertes ERP et intelligence artificielle en temps réel", breadcrumb: ["Administration", "Notifications"], actions: /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5 bg-primary text-primary-foreground shadow hover:bg-primary/90 hover:text-primary-foreground/90", onClick: markAllAsRead, children: [
    ...
    /* @__PURE__ */ jsx(Tabs, { value: tab, onValueChange: (value) => setTab(value), className: "mb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
      ...
      /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
        "Date",
        /* @__PURE__ */ jsx("input", { type: "date", value: selectedDate, onChange: (event) => setSelectedDate(event.target.value), className: "h-9 rounded-md border border-input bg-background px-3 text-sm text-foreground shadow-sm outline-none focus:ring-2 focus:ring-ring", "aria-label": "Filtrer les notifications par date" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx(SectionCard, { title: "Activité", description: `${visibleItems.length} notification${visibleItems.length > 1 ? "s" : ""}${selectedDate ? " pour cette date" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      ...
      !loading && visibleItems.length === 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-14 text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground/70", children: selectedDate ? "Aucune notification pour cette date." : "Aucune notification disponible." })
      ] }),
