...
import { a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-BIAbd_8_.js";
...
import { T as Textarea } from "./textarea-FUQfgY3g.js";
import { S as Switch } from "./switch-C_9FXNPK.js";
import { f as fmtCurrency } from "./erp-data-Byxy0z8s.js";
import { i as api, c as cn } from "./router-qTiJlct9.js";
import { n as normalizeNumberInput, f as formatGroupedInputNumber, a as formatGroupedNumber } from "./number-input-BgmEQ3sF.js";
import { g as getFournisseurs } from "./fournisseurs.service-1-gP37dp.js";
...
function PurchasesPage() {
  ...
  const purchaseColumns = [{
    ...
    render: (o) => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", onClick: (e) => e.stopPropagation(), children: [
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: receptionOpen, onOpenChange: (open) => {
    ...
    }, title: "Nouvelle reception", description: receptionOrder ? `Bon ${receptionOrder.ref} - wizard de reception` : "", size: "xxl", footer: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", disabled: receptionSubmitting, onClick: () => {
        setReceptionOpen(false);
        setReceptionOrder(null);
      }, children: "Annuler" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        receptionStep > 1 ? /* @__PURE__ */ jsxs(Button, { variant: "outline", disabled: receptionSubmitting, onClick: () => setReceptionStep((prev) => Math.max(1, prev - 1)), children: [
          /* @__PURE__ */ jsx(ArrowLeft, { className: "mr-1 h-4 w-4" }),
          " Retour"
        ] }) : null,
        receptionStep < 3 ? /* @__PURE__ */ jsxs(Button, { disabled: receptionSubmitting, onClick: () => {
    ...
    ] }), children: receptionOrder ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-2 flex items-center gap-2", children: [1, 2, 3].map((step) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: `flex h-7 w-7 items-center justify-center rounded-full text-xs font-semibold ${receptionStep >= step ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`, children: step }),
        step < 3 ? /* @__PURE__ */ jsx("span", { className: "h-0.5 w-8 bg-border" }) : null
      ] }, step)) }),
      receptionStep === 1 ? /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { children: "Fournisseur" }),
          /* @__PURE__ */ jsx(Input, { value: detailsOrder?.fournisseur?.raisonSociale || rows.find((item) => item.id === receptionOrder.id)?.fournisseur || "-", disabled: true })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { children: "Bon de commande" }),
          /* @__PURE__ */ jsx(Input, { value: receptionOrder.ref, disabled: true })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "reception-date", children: "Date" }),
          /* @__PURE__ */ jsx(Input, { id: "reception-date", type: "date", className: cn(receptionGeneralErrors.date ? "border-destructive" : ""), value: receptionGeneralForm.date, onChange: (e) => setReceptionGeneralForm((prev) => ({
            ...prev,
            date: e.target.value
          })) }),
          receptionGeneralErrors.date ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: receptionGeneralErrors.date }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2 md:col-span-2", children: [
      ...
      receptionStep === 2 ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        receptionLinesError ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: receptionLinesError }) : null,
        receptionOrder.lines.map((line) => /* @__PURE__ */ jsxs("div", { className: "grid gap-2 rounded-md border border-border p-3 md:grid-cols-[2fr_1fr_1fr_1fr_1fr]", children: [
          /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: line.produit }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Commandee" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold", children: line.quantiteCommandee })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Deja recue" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold", children: line.quantiteDejaRecue })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Reste" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold", children: line.restant })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: `recv-${line.idLigneBcf}`, children: "Recu maintenant" }),
            /* @__PURE__ */ jsx(Input, { id: `recv-${line.idLigneBcf}`, type: "text", inputMode: "decimal", placeholder: "0", value: formatGroupedInputNumber(String(line.quantiteARecevoir)), onChange: (e) => {
      ...
      receptionStep === 3 ? /* @__PURE__ */ jsxs("div", { className: "grid gap-3 md:grid-cols-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border p-3", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Nombre de produits" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-semibold", children: receptionOrder.lines.length })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border p-3", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Quantite totale recue" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-semibold", children: receptionOrder.lines.reduce((acc, line) => acc + line.quantiteARecevoir, 0) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border p-3", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Valeur reception" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-semibold", children: fmtCurrency(receptionOrder.lines.reduce((acc, line) => {
    ...
    /* @__PURE__ */ jsx(AppModal, { open: invoiceWizardOpen, onOpenChange: (open) => {
    ...
    }, title: "Creation facture fournisseur", description: importOrder ? `Bon ${importOrder.ref} - wizard facture fournisseur` : "", size: "xxl", position: "center", footer: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", disabled: invoiceWizardSubmitting, onClick: () => setInvoiceWizardOpen(false), children: "Annuler" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        invoiceWizardStep > 1 ? /* @__PURE__ */ jsxs(Button, { variant: "outline", disabled: invoiceWizardSubmitting, onClick: () => setInvoiceWizardStep((prev) => Math.max(1, prev - 1)), children: [
          /* @__PURE__ */ jsx(ArrowLeft, { className: "mr-1 h-4 w-4" }),
          " Retour"
        ] }) : null,
        invoiceWizardStep < 3 ? /* @__PURE__ */ jsxs(Button, { disabled: invoiceWizardSubmitting, onClick: () => {
      ...
      /* @__PURE__ */ jsx("div", { className: "mb-2 flex items-center gap-2", children: [1, 2, 3].map((step) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: `flex h-7 w-7 items-center justify-center rounded-full text-xs font-semibold ${invoiceWizardStep >= step ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`, children: step }),
        step < 3 ? /* @__PURE__ */ jsx("span", { className: "h-0.5 w-8 bg-border" }) : null
      ] }, step)) }),
      invoiceWizardStep === 1 ? /* @__PURE__ */ jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-number", children: "Numero facture" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-number", placeholder: "Ex: FAC-2026-0001", className: cn(invoiceFormErrors.numeroFacture ? "border-destructive" : ""), value: invoiceForm.numeroFacture, onChange: (e) => setInvoiceForm((prev) => ({
            ...prev,
            numeroFacture: e.target.value
          })) }),
          invoiceFormErrors.numeroFacture ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.numeroFacture }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-date", children: "Date facture" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-date", type: "date", className: cn(invoiceFormErrors.dateFacture ? "border-destructive" : ""), value: invoiceForm.dateFacture, onChange: (e) => setInvoiceForm((prev) => ({
            ...prev,
            dateFacture: e.target.value
          })) }),
          invoiceFormErrors.dateFacture ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.dateFacture }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-due", children: "Date echeance" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-due", type: "date", className: cn(invoiceFormErrors.dateEcheance ? "border-destructive" : ""), value: invoiceForm.dateEcheance, onChange: (e) => setInvoiceForm((prev) => ({
            ...prev,
            dateEcheance: e.target.value
          })) }),
          invoiceFormErrors.dateEcheance ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.dateEcheance }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-ht", children: "Montant HT" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-ht", type: "text", inputMode: "decimal", placeholder: "0", className: cn(invoiceFormErrors.montantHt ? "border-destructive" : ""), value: formatGroupedInputNumber(invoiceForm.montantHt), onChange: (e) => {
          ...
          invoiceFormErrors.montantHt ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.montantHt }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-tva", children: "TVA" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-tva", type: "text", inputMode: "decimal", placeholder: "0", className: cn(invoiceFormErrors.tva ? "border-destructive" : ""), value: formatGroupedInputNumber(invoiceForm.tva), onChange: (e) => {
          ...
          invoiceFormErrors.tva ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.tva }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-ttc", children: "TTC" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-ttc", type: "text", inputMode: "decimal", placeholder: "0", readOnly: true, className: cn("bg-muted/40", invoiceFormErrors.ttc ? "border-destructive" : ""), value: formatGroupedInputNumber(invoiceForm.ttc) }),
          invoiceFormErrors.ttc ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.ttc }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-remise", children: "Remise" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-remise", type: "text", inputMode: "decimal", placeholder: "0", className: cn(invoiceFormErrors.remise ? "border-destructive" : ""), value: formatGroupedInputNumber(invoiceForm.remise), onChange: (e) => setInvoiceForm((prev) => ({
            ...prev,
            remise: normalizeNumberInput(e.target.value)
          })) }),
          invoiceFormErrors.remise ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.remise }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "invoice-transport", children: "Transport" }),
          /* @__PURE__ */ jsx(Input, { id: "invoice-transport", type: "text", inputMode: "decimal", placeholder: "0", className: cn(invoiceFormErrors.transport ? "border-destructive" : ""), value: formatGroupedInputNumber(invoiceForm.transport), onChange: (e) => setInvoiceForm((prev) => ({
            ...prev,
            transport: normalizeNumberInput(e.target.value)
          })) }),
          invoiceFormErrors.transport ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.transport }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2 md:col-span-2", children: [
      ...
      invoiceWizardStep === 2 ? /* @__PURE__ */ jsxs("div", { className: "grid gap-4 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "supplier-invoice-file", children: "Fichier PDF" }),
          /* @__PURE__ */ jsx(Input, { id: "supplier-invoice-file", type: "file", accept: "application/pdf,.pdf", className: cn(invoiceFormErrors.file ? "border-destructive" : ""), onChange: (e) => {
          ...
          invoiceFormErrors.file ? /* @__PURE__ */ jsx("p", { className: "text-xs text-destructive", children: invoiceFormErrors.file }) : null,
          importFile ? /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground", children: [
            importFile.name,
            " ·",
            " ",
            (importFile.size / 1024 / 1024).toFixed(2),
            " Mo"
          ] }) : /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Importez le PDF de facture fournisseur." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "rounded-md border border-border p-2", children: importFile && importFile.type === "application/pdf" && importPreviewUrl ? /* @__PURE__ */ jsx("iframe", { src: importPreviewUrl, title: "Apercu facture fournisseur", className: "h-[58vh] w-full rounded-md" }) : /* @__PURE__ */ jsx("div", { className: "flex h-[58vh] items-center justify-center text-sm text-muted-foreground", children: "Selectionnez un PDF pour afficher l'apercu." }) })
      ] }) : null,
      invoiceWizardStep === 3 ? /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border p-3", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold", children: "Revue generale" }),
          /* @__PURE__ */ jsxs("div", { className: "mt-2 grid gap-2 text-sm md:grid-cols-2", children: [
            /* @__PURE__ */ jsxs("p", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Numero:" }),
              " ",
            ...
            /* @__PURE__ */ jsxs("p", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Echeance:" }),
              " ",
            ...
            /* @__PURE__ */ jsxs("p", { children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "TTC:" }),
              " ",
              formatGroupedNumber(invoiceForm.ttc)
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "La validation cree la facture fournisseur et la dette associee dans le workflow existant." })
      ] }) : null
    ] }) }),
