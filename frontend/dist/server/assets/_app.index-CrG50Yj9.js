...
import { u as useDashboardStore, E as EMPTY_DASHBOARD_OVERVIEW, g as getDashboardPdf } from "./dashboard.store-xZQKiLDF.js";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Repartition des stocks", description: "Par categorie de produits", headerGradient: true, children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-72", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(PieChart, { children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Marge mensuelle", description: "Ventes - achats sur 12 mois", headerGradient: true, children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-72", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: margeTrend, margin: {
        left: -10,
        right: 8,
        top: 8
      }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "Produits les plus vendus", description: "Top 5 ce mois-ci", headerGradient: true, children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: topProducts, layout: "vertical", margin: {
        left: 40,
        right: 16
      }, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Ventes recentes par statut", description: "Repartition des dernieres ventes", headerGradient: true, children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(PieChart, { children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Alertes & notifications", description: "Elements necessitant votre attention", headerGradient: true, action: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/notifications", children: "Tout voir" }) }), children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-1", children: visibleAlerts.map((a) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 rounded-lg border border-border p-3", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(SectionCard, { title: "Dernieres ventes", description: "Activite recente", headerGradient: true, action: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/sales", children: "Tout voir" }) }), children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
