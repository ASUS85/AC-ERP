...
import { s as salesTrend, f as fmtCurrency, b as stockSplit, t as topProducts } from "./erp-data-CgsBYils.js";
import { TrendingUp, ShoppingCart, Banknote, Warehouse } from "lucide-react";
import "@tanstack/react-router";
import "react";
import "./input-BiB-PFhx.js";
...
function StatsPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsx(StatCard, { label: "Ventes (an)", value: "780 300 €", delta: "+14 %", up: true, sub: "cumulé 2026", icon: /* @__PURE__ */ jsx(TrendingUp, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "Achats (an)", value: "439 400 €", delta: "+9 %", up: true, sub: "cumulé 2026", icon: /* @__PURE__ */ jsx(ShoppingCart, { className: "h-5 w-5" }) }),
