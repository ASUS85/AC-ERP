...
import { S as StatCard, a as SectionCard, P as Pagination, b as SearchableSelect } from "./widgets-CNypZ_eQ.js";
...
import { T as Textarea } from "./textarea-dOLYpzDE.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DFP2BSph.js";
import { toast } from "sonner";
import { u as useCategoriesStore, a as updateCategorie, c as createCategorie, d as deleteCategorie } from "./categories.store-CHhkcFZv.js";
...
function CategoriesPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsx(StatCard, { label: "Sous-catégories", value: String(arbre.reduce((total, categorie) => total + (categorie.enfants?.length || 0), 0)), sub: "au total", icon: /* @__PURE__ */ jsx(FolderTree, { className: "h-5 w-5" }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxs(SectionCard, { title: "Toutes les categories", className: "lg:col-span-3", description: `${meta.total} categorie${meta.total > 1 ? "s" : ""}`, children: [
