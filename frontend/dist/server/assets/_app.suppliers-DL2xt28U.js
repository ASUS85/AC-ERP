...
import { S as StatCard, a as SectionCard, P as Pagination } from "./widgets-BIAbd_8_.js";
...
import { g as getFournisseurs, a as getFournisseurById, u as updateFournisseur, c as createFournisseur } from "./fournisseurs.service-1-gP37dp.js";
...
function SuppliersPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editing ? "Modifier un fournisseur" : "Ajouter un fournisseur", description: "Renseignez les coordonnées du fournisseur.", size: "xl", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Field, { label: "Delai livraison (jours)", htmlFor: "delaiLivraisonMoyen", children: /* @__PURE__ */ jsx(Input, { id: "delaiLivraisonMoyen", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(String(form.delaiLivraisonMoyen || "")), onChange: (e) => setField("delaiLivraisonMoyen", Number(normalizeNumberInput(e.target.value)) || 7) }) }),
