...
import { S as StatCard, a as SectionCard, P as Pagination, b as SearchableSelect } from "./widgets-DrjmuOnd.js";
...
import { i as api, c as cn } from "./router-CbAtk_cD.js";
    ...
    try {
      const [skRes, mvRes, alRes, invRes, prodRes] = await Promise.allSettled([
        ...
        (async () => {
          const {
            default: api2
          } = await import("./router-CbAtk_cD.js").then((n) => n.s);
