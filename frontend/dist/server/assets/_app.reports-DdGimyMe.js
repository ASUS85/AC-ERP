...
import { a as SectionCard } from "./widgets-BODimdeo.js";
...
import { g as genererRapport, t as telechargerRapportPdf } from "./ia.service-N5MQ3o9c.js";
...
function ReportsPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxs(SectionCard, { title: "Configuration", description: "Choisissez le type de rapport", headerGradient: true, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Prévisualisation", description: active.label, className: "lg:col-span-2", headerGradient: true, action: report && /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", onClick: () => void downloadReport(), disabled: downloading, children: [
