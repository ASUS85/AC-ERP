...
import { S as StatCard, a as SectionCard } from "./widgets-42npvNwp.js";
import { C as ChartFrame } from "./ChartFrame-7WcZ8ief.js";
import { f as fmtCurrency } from "./erp-data-De0hQiRg.js";
import { g as getDashboardOverview } from "./dashboard.service-CGXx_8Gw.js";
...
import "./router-CpiKU9_2.js";
import "@tanstack/react-query";
import "clsx";
import "tailwind-merge";
import "zod";
import "axios";
import "./input-mFyUeWQX.js";
import "@radix-ui/react-slot";
import "class-variance-authority";
import "react-dom";
import "./skeleton-BbHqxrvf.js";
...
function StatsPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "Ventes vs achats", description: "Comparatif mensuel", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: salesTrend, margin: {
        left: -10,
        right: 8
      }, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Évolution du chiffre d'affaires", description: "Tendance annuelle", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(AreaChart, { data: salesTrend, margin: {
        left: -10,
        right: 8
      }, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Top produits", description: "Meilleures ventes", children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: topProducts, layout: "vertical", margin: {
        left: 40,
        right: 16
      }, children: [
