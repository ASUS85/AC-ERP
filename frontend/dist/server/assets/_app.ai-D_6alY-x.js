...
import { x as salesForecast, f as fmtCurrency, y as stockRisks } from "./erp-data-CgsBYils.js";
...
function AiPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsx(StatCard, { label: "CA prévu (juil.)", value: "98 200 €", delta: "+6,2 %", up: true, sub: "vs juin", icon: /* @__PURE__ */ jsx(TrendingUp, { className: "h-5 w-5" }) }),
