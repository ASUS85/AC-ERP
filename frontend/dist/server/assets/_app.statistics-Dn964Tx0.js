...
import { u as useDashboardStore, b as getTopClients, E as EMPTY_DASHBOARD_OVERVIEW, g as getLast12CompletedMonths } from "./getlast12Monts-KEi8Q0jH.js";
import { i as api } from "./router-DmDzdhp9.js";
import "@tanstack/react-router";
import "./input-Di0llSdw.js";
...
function StatsPage() {
  ...
  const monthlyDataCompleted = useMemo(() => getLast12CompletedMonths(monthlyData, "mois"), [monthlyData]);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "CA mensuel", description: "Chiffre d'affaires", headerGradient: true, children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(AreaChart, { data: monthlyDataCompleted, margin: {
        left: -10,
        right: 8
      }, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Marge mensuelle", description: "Ventes moins achats", headerGradient: true, children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-64", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data: monthlyDataCompleted, margin: {
        left: -10,
        right: 8
      }, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: grid, vertical: false }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "Ventes vs achats", description: "Comparatif mensuel", headerGradient: true, children: /* @__PURE__ */ jsx(ChartFrame, { loading, className: "h-80", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(ComposedChart, { data: monthlyDataCompleted, margin: {
        left: -10,
        right: 8
      }, children: [
        /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: grid, vertical: false }),
