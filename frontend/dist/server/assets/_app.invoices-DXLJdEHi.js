...
import { S as StatCard, a as SectionCard, T as Toolbar, P as Pagination } from "./widgets-B15eBu3V.js";
...
import { f as fmtCurrency, i as invoices } from "./erp-data-BPnqaKp2.js";
...
function InvoicesPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsx(StatCard, { label: "Total facturé", value: fmtCurrency(284750), sub: "ce mois", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "Payées", value: fmtCurrency(248100), sub: "encaissées", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "En attente", value: fmtCurrency(18230), sub: "à venir", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "En retard", value: fmtCurrency(18420), sub: "5 factures", icon: /* @__PURE__ */ jsx(FileText, { className: "h-5 w-5" }) })
    ] }),
