...
import { S as StatCard, a as SectionCard, P as Pagination } from "./widgets-BO9olZIU.js";
...
import { g as getCategories, a as getArbreCategories, u as updateCategorie, c as createCategorie, d as deleteCategorie } from "./categories.service-BhRtDEv_.js";
...
function CategoriesPage() {
  ...
  const loadCategories = useCallback(async () => {
    setLoading(true);
    try {
      const [catRes, arbreRes, allCatRes] = await Promise.all([getCategories({
        page,
        limit: pageSize,
        search: search || void 0
      }), getArbreCategories(), getCategories({
        limit: 1e4
      })]);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editing ? "Modifier une categorie" : "Ajouter une categorie", description: "Organisez votre catalogue par categories.", size: "lg", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Field, { label: "Nom", htmlFor: "nom", error: errors.nom, children: /* @__PURE__ */ jsx(Input, { id: "nom", value: form.nom, onChange: (e) => setField("nom", e.target.value), placeholder: "Nom de la categorie" }) }),
      /* @__PURE__ */ jsx(Field, { label: "Categorie parente", htmlFor: "parent", children: /* @__PURE__ */ jsxs(Select, { value: form.idCategorieParent || "", onValueChange: (value) => setField("idCategorieParent", value || null), children: [
        /* @__PURE__ */ jsx(SelectTrigger, { id: "parent", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Aucune (categorie racine)" }) }),
        /* @__PURE__ */ jsx(SelectContent, { position: "popper", className: "max-h-[240px]", children: parentOptions.map((opt) => /* @__PURE__ */ jsx(SelectItem, { value: opt.value, children: opt.label }, opt.value)) })
      ] }) }),
    ...
    /* @__PURE__ */ jsx(AppModal, { open: deleteModalOpen, onOpenChange: setDeleteModalOpen, title: "Confirmer la suppression", description: "La categorie sera supprimee definitivement.", size: "sm", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-2", children: [
