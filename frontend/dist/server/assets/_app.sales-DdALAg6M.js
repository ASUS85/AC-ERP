...
import { ShoppingCart, Receipt, Search, Loader2, RefreshCw, User, UserRound, Minus, Plus, Trash2, FileText, Wallet, AlertCircle } from "lucide-react";
import { P as PageHeader } from "./PageHeader-D6EtHCBB.js";
import { a as SectionCard, b as SearchableSelect, P as Pagination } from "./widgets-BODimdeo.js";
...
import { g as getFactures, a as getFactureById, b as getFacturePdf } from "./factures.service-DiXS36tW.js";
import { i as api, c as cn } from "./router-DmDzdhp9.js";
import { c as createPaiement } from "./paiements.service-DRXWWyrK.js";
import { toast } from "sonner";
import { a as resolveMediaUrl } from "./avatar-Abbf1WZy.js";
import { u as useProductsStore } from "./products.store-D75SWcNu.js";
import { u as useClientsStore } from "./clients.store-B-yYB7Ag.js";
...
function SalesPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([fetchProducts({
      limit: 1e3,
      statut: "ACTIF"
    }).then((response) => setProducts(responseData(response))), fetchClients({
      limit: 500,
      statut: "ACTIF"
    }).then((response) => setClients(responseData(response)))]).catch(() => toast.error("Impossible de charger les données de vente")).finally(() => setLoading(false));
    void loadHistory();
  ...
  useEffect(() => {
    if (clientMode === "OCCASIONNEL" || !paidAmount || toNumber(paidAmount) === 0) {
  ...
  const validateBeforeConfirm = () => {
    ...
    if (clientMode === "OCCASIONNEL" && Math.abs(paid - totals.totalTtc) > 0.01) {
  ...
  const handleAddPayment = async () => {
    ...
    const soldeDu = Math.max(0, toNumber(historyDetail.totalTtc) - toNumber(historyDetail.montantPaye));
    if (amount > soldeDu) {
    ...
    try {
      await createPaiement({
        ...
        reference: newPaymentRef || void 0,
      ...
      const message = error && typeof error === "object" && "message" in error ? String(error.message) : "Erreur lors de l'ajout du paiement";
      toast.error(message);
    } finally {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Tabs, { defaultValue: "new", children: [
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "new", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 items-start gap-4 lg:grid-cols-3", children: [
        /* @__PURE__ */ jsxs(SectionCard, { title: "Catalogue", description: "Cliquez pour ajouter au panier", className: "min-h-0 lg:col-span-2", contentClassName: "flex min-h-0 flex-1 flex-col", headerGradient: true, style: catalogHeight ? {
          height: `${catalogHeight}px`
        } : void 0, action: /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", onClick: () => void refreshCatalog(), disabled: refreshing || loading, children: [
          ...
          loading ? /* @__PURE__ */ jsx("div", { className: "flex justify-center py-12", children: /* @__PURE__ */ jsx(Loader2, { className: "h-6 w-6 animate-spin text-muted-foreground" }) }) : /* @__PURE__ */ jsx("div", { className: "grid min-h-0 flex-1 grid-cols-2 content-start gap-3 overflow-y-auto pr-1 sm:grid-cols-3", children: filteredProducts.slice(0, 18).map((product) => {
            const stock = toNumber(product.stock?.stockActuel);
            return /* @__PURE__ */ jsxs("div", { role: "button", tabIndex: 0, onClick: () => addProduct(product), onKeyDown: (event) => {
              if (event.key === "Enter" || event.key === " ") {
                event.preventDefault();
                addProduct(product);
              }
            }, className: "group rounded-lg border border-border p-3 text-left transition-all hover:border-primary/40 hover:shadow-card", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-1 flex items-center justify-between gap-2", children: [
                ...
                }, className: "text-xs font-medium text-muted-foreground transition-colors hover:text-primary bg-secondary/50 p-1", children: "Détail" })
              ] })
            ] }, product.id);
          }) })
        ] }),
        /* @__PURE__ */ jsx("div", { ref: cartCardRef, children: /* @__PURE__ */ jsxs(SectionCard, { title: "Panier", description: `${cart.length} article(s)`, className: "min-h-0", contentClassName: "min-h-0", headerGradient: true, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsx(Input, { id: "paidAmount", type: "text", inputMode: "decimal", value: formatGroupedInputNumber(paidAmount, {
                allowNegative: false
              }), onChange: (event) => setPaidAmount(normalizeNumberInput(event.target.value, {
                allowNegative: false
              })), placeholder: "Montant payé", readOnly: clientMode === "OCCASIONNEL" })
            ] }),
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "list", children: /* @__PURE__ */ jsxs(SectionCard, { title: "Historique des ventes", headerGradient: true, children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: Boolean(selectedProductDetail), onOpenChange: (open) => {
      if (!open) setSelectedProductDetail(null);
    }, title: selectedProductDetail?.designation || "Détail du produit", description: selectedProductDetail?.reference || "Produit", size: "lg", footer: /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: () => setSelectedProductDetail(null), children: "Fermer" }) }), children: selectedProductDetail ? /* @__PURE__ */ jsxs("div", { className: "grid gap-5 md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]", children: [
      /* @__PURE__ */ jsx("div", { className: "flex min-h-64 items-center justify-center overflow-hidden rounded-lg bg-secondary/60 text-primary", children: selectedProductDetail.photo ? /* @__PURE__ */ jsx("img", { src: resolveMediaUrl(selectedProductDetail.photo), alt: selectedProductDetail.designation, className: "h-full max-h-[420px] w-full object-contain", onError: (e) => {
        e.currentTarget.style.display = "none";
      } }) : /* @__PURE__ */ jsx(ShoppingCart, { className: "h-14 w-14 opacity-70" }) }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-sm", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs uppercase text-muted-foreground", children: "Désignation" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 font-medium text-foreground", children: selectedProductDetail.designation })
        ] }),
        selectedProductDetail.description?.trim() ? /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs uppercase text-muted-foreground", children: "Description" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 whitespace-pre-line text-foreground", children: selectedProductDetail.description })
        ] }) : null,
        /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border p-3", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Référence" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 font-medium text-foreground", children: selectedProductDetail.reference })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border p-3", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Catégorie" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 font-medium text-foreground", children: selectedProductDetail.categorie?.nom || "-" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border p-3", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Stock" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 font-medium text-foreground", children: toNumber(selectedProductDetail.stock?.stockActuel) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border p-3", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "TVA" }),
            /* @__PURE__ */ jsxs("p", { className: "mt-1 font-medium text-foreground", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border p-3", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Prix de vente HT" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-lg font-semibold text-primary", children: fmtCurrency(toNumber(selectedProductDetail.prixVenteHt)) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border p-3", children: [
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Prix estimé TTC" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 font-semibold text-foreground", children: fmtCurrency(toNumber(selectedProductDetail.prixVenteHt) * (1 + toNumber(selectedProductDetail.tauxTva) / 100)) })
        ] })
      ] })
    ] }) : null }),
    ...
    /* @__PURE__ */ jsx(AppModal, { open: historyDetailOpen, onOpenChange: setHistoryDetailOpen, title: "Détail de la facture", description: historyDetail?.numeroFacture || "Facture", size: "xl", footer: /* @__PURE__ */ jsx("div", { className: "flex justify-end w-full", children: /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: () => setHistoryDetailOpen(false), children: "Fermer" }) }), children: historyDetailLoading ? /* @__PURE__ */ jsx("div", { className: "flex justify-center py-10", children: /* @__PURE__ */ jsx(Loader2, { className: "h-6 w-6 animate-spin text-muted-foreground" }) }) : historyDetail ? /* @__PURE__ */ jsxs(Tabs, { defaultValue: "details", className: "w-full", children: [
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "paiements", children: historyDetail.paiements && historyDetail.paiements.length > 0 ? /* @__PURE__ */ jsx("div", { className: "rounded-md border border-border", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-border", children: historyDetail.paiements.map((p) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-muted/50 transition-colors", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: p.reference || "-" }),
