...
import { a as SectionCard } from "./widgets-TR90zn21.js";
import { c as cn, u as useGlobalLoader } from "./router-DKXtA4iJ.js";
import { I as Input, B as Button } from "./input-Bxvgloed.js";
import { L as Label } from "./label-DSb173XT.js";
import * as SwitchPrimitives from "@radix-ui/react-switch";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-CVIDf1Iv.js";
import { g as getMe, c as getSessions, u as uploadAvatar, d as updateProfile, e as changePassword, h as revokeOtherSessions } from "./auth.service-um1aJmJk.js";
import { r as resolveAvatarUrl } from "./avatar-BNX3YXxG.js";
    ...
    /* @__PURE__ */ jsxs(Tabs, { defaultValue: "profile", children: [
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "company", children: /* @__PURE__ */ jsxs(SectionCard, { title: "Paramètres entreprise", description: "Informations utilisées sur les documents et rapports", children: [
        company && /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsx(Field, { label: "Devise", value: company.devise, placeholder: "XAF", required: true, error: companyErrors.devise, onChange: (devise) => updateCompanyField("devise", devise) }),
