...
import { c as getPrevisions } from "./ia.service-BXOJWiSI.js";
...
function AiPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Recommandations IA", description: "Actions prioritaires", headerGradient: true, children: /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(SectionCard, { title: "Risques de rupture de stock", description: "Produits critiques détectés par l'IA", headerGradient: true, children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
