...
function SearchableSelect({
  ...
  const [pos, setPos] = React.useState({ top: 0, left: 0, width: 0, maxHeight: dropdownMaxHeight });
  const updatePosition = React.useCallback(() => {
    ...
    const maxH = Math.max(120, Math.min(dropdownMaxHeight, up ? above - 12 : below - 12));
    setPos({
      left: rect.left,
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "overflow-y-auto flex-1 py-1", style: { maxHeight: pos.maxHeight - 55 }, children: filtered.length === 0 ? /* @__PURE__ */ jsx("div", { className: "px-3 py-6 text-center text-sm text-muted-foreground", children: emptyMessage }) : filtered.map((option) => {
