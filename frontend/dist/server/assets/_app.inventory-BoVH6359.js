...
import { S as StatCard, a as SectionCard, P as Pagination, b as SearchableSelect } from "./widgets-BO9olZIU.js";
...
import { d as fmtNumber } from "./erp-data-C0zPHDd1.js";
...
function InventoryPage() {
    ...
    try {
      const [skRes, mvRes, alRes, invRes, prodRes] = await Promise.all([
        ...
        (async () => {
          const {
            default: api2
          } = await import("./client-C7e4CO8z.js");
      ...
      setStocks(skRes?.data || []);
      setSkMeta(skRes?.meta || {
        total: 0,
        page: skPage,
        limit: PAGE_SIZE,
        totalPages: 1
      ...
      setInvMeta({
        total: (invRes?.data || []).length,
        page: 1,
        limit: 1e4,
        totalPages: 1
      });
      const produitsRaw = prodRes?.data || [];
  ...
  const totalSkPages = Math.ceil(filteredStocks.length / PAGE_SIZE) || 1;
  const paginatedStocks = filteredStocks.slice((skPage - 1) * PAGE_SIZE, skPage * PAGE_SIZE);
  const totalInvPages = Math.ceil(inventaires.length / PAGE_SIZE) || 1;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsx(StatCard, { label: "Valeur du stock", value: fmtNumber(stats.valeur) + " f", sub: "prix de vente", icon: /* @__PURE__ */ jsx(Warehouse, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsx(StatCard, { label: "Produits en stock", value: String(stocks.length), sub: "reference(s)", icon: /* @__PURE__ */ jsx(Warehouse, { className: "h-5 w-5" }) }),
