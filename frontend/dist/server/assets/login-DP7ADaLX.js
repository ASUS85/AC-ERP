...
import { c as cn, a as Route, l as login, f as forgotPassword, v as verifyMfa, b as resendMfa, d as canAccessPermission } from "./router-Dv1ROSYY.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "lg:flex lg:flex-col lg:justify-start lg:p-12 items-center justify-center bg-background px-6 py-12", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-full max-w-sm", children: [
        ...
        step === "resetSent" && /* @__PURE__ */ jsxs("div", { className: "mt-2", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary", children: /* @__PURE__ */ jsx(MailCheck, { className: "h-6 w-6" }) }),
