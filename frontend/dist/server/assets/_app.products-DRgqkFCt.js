...
import { S as StatCard, a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-BODimdeo.js";
...
import { u as useProductsStore, g as getProduitsPdf, a as uploadProduitPhoto, b as updateProduit, c as createProduit, d as archiveProduit } from "./products.store-D75SWcNu.js";
...
import { u as useCategoriesStore } from "./categories.store-CfZ814mf.js";
...
function ProductsPage() {
  ...
  const cols = [{
    ...
    render: (product) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "truncate text-xs text-muted-foreground", children: product.reference })
      ] })
    ] })
  }, {
    key: "categorie",
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(SectionCard, { title: "Catalogue produits", description: `${meta.total} produit${meta.total > 1 ? "s" : ""}`, action: /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", onClick: () => void refreshProducts(), disabled: refreshing, children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsx(Toolbar, { placeholder: "Rechercher un produit…", addLabel: canCreate ? "Ajouter un produit" : void 0, searchValue: search, onSearchChange: setSearch, filterOptions, selectedFilter: categoryFilter, onFilterChange: setCategoryFilter, filterPlaceholder: "Toutes les catégories", filterSearchPlaceholder: "Rechercher une catégorie…", onAdd: canCreate ? openCreateModal : void 0 }) }),
      loading ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center py-10 text-muted-foreground", children: [
        /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }),
        " Chargement…"
      ] }) : /* @__PURE__ */ jsx(DataTable, { columns: cols, rows: products, rowKey: (product) => product.id, withActions: canEdit || canDelete, rowActions: (product) => [...canEdit ? [{
        label: "Modifier",
