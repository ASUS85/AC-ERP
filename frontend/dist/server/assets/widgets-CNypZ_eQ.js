...
function StatCard({
  ...
  return /* @__PURE__ */ jsxs(
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -right-6 -top-6 h-24 w-24 rounded-full bg-current opacity-[0.06]" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold tracking-tight text-foreground", children: value }),
  ...
  return /* @__PURE__ */ jsxs(
    Card,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: cn("p-3", contentClassName), children })
      ]
    }
  );
}
