...
import { FileEdit, CheckCircle2, Truck, PackageCheck, Plus, Loader2, Trash2, ArrowLeft, ArrowRight, Printer, Download, Copy, Send } from "lucide-react";
import { P as PageHeader } from "./PageHeader-Dn6TWXax.js";
import { a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-dh2l9GK9.js";
...
import { B as Button, I as Input } from "./input-DgNX5wjv.js";
import { L as Label } from "./label-D88VLxpo.js";
import { T as Textarea } from "./textarea-Cdhg8HkB.js";
import { f as fmtCurrency } from "./erp-data-C8LoOZfP.js";
import { i as api, c as cn } from "./router-soiu03Zn.js";
import { g as getFournisseurs } from "./fournisseurs.service-B3evNS_5.js";
import { g as getProduits } from "./produits.service-iBkX0YUV.js";
...
function PurchasesPage() {
  ...
  const openImportInvoiceModal = async (orderId) => {
    ...
    try {
      const response = await getFacturesImporteesBcf(orderId);
      setImportedInvoices(Array.isArray(response?.data) ? response.data : []);
    } catch (error) {
      const maybeMessage = error && typeof error === "object" && "message" in error ? String(error.message || "") : "";
      toast.error(maybeMessage.trim() || "Impossible de charger les factures importees");
      setImportedInvoices([]);
    } finally {
  ...
  const actionsByStatus = (row) => {
    ...
    if (row.statutRaw === "RECU_PARTIEL") {
      return [
        makeAction("import-invoice", "Importer facture fournisseur", /* @__PURE__ */ jsx(FileEdit, { className: "mr-2 h-4 w-4" }), () => openImportInvoiceModal(row.id)),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(SectionCard, { title: "Bons de commande", children: [
      ...
      loading ? /* @__PURE__ */ jsx("div", { className: "flex justify-center py-10", children: /* @__PURE__ */ jsx(Loader2, { className: "h-6 w-6 animate-spin text-muted-foreground" }) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(DataTable, { columns: cols, rows: paginatedRows, rowKey: (o) => o.id, rowActions: actionsByStatus, isRowActionLoading: (o) => Boolean(rowActionPendingById[o.id]) }),
    ...
    /* @__PURE__ */ jsx(AppModal, { open: importOpen, onOpenChange: (open) => {
      setImportOpen(open);
      if (!open) {
        setImportOrder(null);
        setImportFile(null);
    ...
    }, title: "Import facture fournisseur", description: importOrder ? `Bon ${importOrder.ref} - importer un document fournisseur (PDF, DOC, DOCX)` : "", size: "xxl", footer: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", disabled: importSubmitting, onClick: () => setImportOpen(false), children: "Fermer" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxs(Button, { variant: "outline", disabled: importSubmitting || !importFile, onClick: () => void submitImportInvoiceDecision("REJETER"), children: [
          importSubmitting ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : null,
          "Rejeter"
        ] }),
        /* @__PURE__ */ jsxs(Button, { disabled: importSubmitting || !importFile, onClick: () => void submitImportInvoiceDecision("VALIDER"), children: [
          importSubmitting ? /* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : null,
          "Valider"
        ] })
      ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "supplier-invoice-file", children: "Fichier facture fournisseur (PDF, DOC, DOCX)" }),
          /* @__PURE__ */ jsx(Input, { id: "supplier-invoice-file", type: "file", accept: "application/pdf,.pdf,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document", onChange: (e) => onImportFileChange(e.target.files?.[0] || null) }),
          importFile ? /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground", children: [
            ...
            " Mo"
          ] }) : /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Ajoutez la facture fournisseur puis choisissez Valider ou Rejeter." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border p-3", children: [
          /* @__PURE__ */ jsx("p", { className: "mb-2 text-sm font-medium", children: "Factures deja importees" }),
          importedInvoicesLoading ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }),
            " Chargement..."
          ] }) : importedInvoices.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Aucune facture importee pour ce bon." }) : /* @__PURE__ */ jsx("div", { className: "max-h-[280px] space-y-2 overflow-y-auto pr-1", children: importedInvoices.map((item) => /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border/70 px-3 py-2 text-sm", children: [
            /* @__PURE__ */ jsx("p", { className: "font-medium text-foreground", children: item.numeroFacture }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Decision: ",
              item.decision || "-",
              " · Statut: ",
            ...
            item.fileUrl ? /* @__PURE__ */ jsx("a", { href: `${"http://localhost:3000/api/v1"?.replace(/\/api\/v1\/?$/, "") || "http://localhost:3000"}${item.fileUrl}`, target: "_blank", rel: "noreferrer", className: "text-xs text-primary underline", children: "Ouvrir le fichier" }) : null
          ] }, item.id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "rounded-md border border-border p-2", children: importFile ? importFile.type === "application/pdf" && importPreviewUrl ? /* @__PURE__ */ jsx("iframe", { src: importPreviewUrl, title: "Apercu facture fournisseur", className: "h-[68vh] w-full rounded-md" }) : /* @__PURE__ */ jsx("div", { className: "flex h-[68vh] items-center justify-center text-center text-sm text-muted-foreground", children: "Apercu integre indisponible pour ce format.\\nLe document sera tout de meme importe." }) : /* @__PURE__ */ jsx("div", { className: "flex h-[68vh] items-center justify-center text-sm text-muted-foreground", children: "Selectionnez un fichier pour afficher l'apercu." }) })
    ] }) }),
