...
import { S as StatCard, a as SectionCard } from "./widgets-Bk5igfjY.js";
...
import { g as getStoredCurrency } from "./currency-BGNe4_9Y.js";
import { f as fmtCurrency } from "./erp-data-DmZyEQ_I.js";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsx(SectionCard, { title: "Evolution des ventes & achats", description: "Chiffre d'affaires mensuel sur 12 mois", className: "lg:col-span-2", children: /* @__PURE__ */ jsx("div", { className: "h-72", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(AreaChart, { data: salesTrend, margin: {
        left: -10,
        right: 8,
        top: 8
      }, children: [
      ...
      /* @__PURE__ */ jsx(SectionCard, { title: "Repartition des stocks", description: "Par categorie de produits", children: /* @__PURE__ */ jsx("div", { className: "h-72", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(PieChart, { children: [
