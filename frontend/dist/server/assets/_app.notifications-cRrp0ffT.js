...
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-B4FgOFWL.js";
import { g as getNotifications, a as marquerToutesLues, m as marquerLue } from "./notifications.service-SGn_3CL4.js";
...
function NotificationsPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(SectionCard, { title: "Activité", description: `${visibleItems.length} notification${visibleItems.length > 1 ? "s" : ""} pour cette date`, children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      ...
      !loading && visibleItems.length === 0 && /* @__PURE__ */ jsx("p", { className: "py-8 text-center text-sm text-muted-foreground", children: "Aucune notification pour cette date." }),
