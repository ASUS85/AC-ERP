  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    loading ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center py-10 text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3", children: roles.map((role) => {
        ...
        return /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setSelectedRoleId(role.id), className: `rounded-sm border p-4 text-left shadow-card transition ${isActive ? "border-primary bg-primary/5" : "border-border bg-card hover:border-primary/40"}`, children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editingRole ? "Modifier un rôle" : "Ajouter un rôle", description: editingRole ? "Mettre à jour les informations du rôle." : "Créez un nouveau rôle métier.", size: "md", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
