...
import { ArrowDownToLine, ClipboardList, Warehouse, ArrowUpFromLine, AlertTriangle, Loader2, RefreshCw, CheckCircle2, Ban, Save, Package, XCircle, AlertCircle } from "lucide-react";
...
import { T as Textarea } from "./textarea-jGtEZEV7.js";
...
function InventoryPage() {
  ...
  const loadAll = useCallback(async (force = false) => {
    ...
    try {
      const [skRes, mvRes, alRes, invRes, prodRes] = await Promise.allSettled([getStocks({
        ...
        const {
          default: api2
        } = await import("./router-DmDzdhp9.js").then((n) => n.q);
  ...
  const stockCols = [{
    ...
    render: (s) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx("span", { className: "flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-primary/10 text-primary", children: s.produit.photo ? /* @__PURE__ */ jsx("img", { src: resolveMediaUrl(s.produit.photo), alt: s.produit.designation, className: "h-full w-full rounded-lg object-cover", onError: (e) => {
        e.currentTarget.style.display = "none";
      } }) : /* @__PURE__ */ jsx(Package, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsx("p", { className: "truncate font-medium text-foreground", children: s.produit.designation }),
        /* @__PURE__ */ jsx("p", { className: "truncate text-xs text-muted-foreground", children: s.produit.reference })
      ] })
    ] })
  }, {
    key: "categorie",
  ...
  const mvCols = [{
    ...
    header: "Produit",
    align: "left",
    render: (m) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx("span", { className: "flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-primary/10 text-primary", children: m.produit.photo ? /* @__PURE__ */ jsx("img", { src: resolveMediaUrl(m.produit.photo), alt: m.produit.designation, className: "h-full w-full rounded-lg object-cover", onError: (e) => {
        e.currentTarget.style.display = "none";
      } }) : /* @__PURE__ */ jsx(Package, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsx("p", { className: "truncate font-medium text-foreground", children: m.produit.designation }),
        /* @__PURE__ */ jsx("p", { className: "truncate text-xs text-muted-foreground", children: m.produit.reference })
      ] })
    ] })
  }, {
    key: "typeMouvement",
    ...
    /* @__PURE__ */ jsx(PageHeader, { title: "Gestion des stocks", description: "Vue globale, mouvements et alertes de rupture", breadcrumb: ["Gestion commerciale", "Stocks"], actions: /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(Button, { size: "sm", className: "gap-1.5", onClick: async () => {
        try {
          ...
          toast.warning("Impossible de créer l'inventaire. Veillez terminer l'inventaire en cours et verifier votre connexion internet");
        }
      }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxs(SectionCard, { title: tab === "stocks" ? "Stock actuel" : tab === "mouvements" ? "Mouvements de stock" : "Inventaires physiques", description: tab === "stocks" ? `${skMeta.total} produit${skMeta.total > 1 ? "s" : ""}` : tab === "mouvements" ? `${mvMeta.total} mouvement${mvMeta.total > 1 ? "s" : ""}` : `${invMeta.total} inventaire${invMeta.total > 1 ? "s" : ""}`, className: "lg:col-span-3", action: /* @__PURE__ */ jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", onClick: () => void refreshStocks(), disabled: refreshing || loading, children: [
        ...
        loading ? /* @__PURE__ */ jsx("div", { className: "flex justify-center py-10", children: /* @__PURE__ */ jsx(Loader2, { className: "animate-spin" }) }) : tab === "stocks" ? /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx(DataTable, { columns: invCols, rows: paginatedInventaires, rowKey: (i) => i.id, onRowClick: (p) => void openInvDetail(p.id), withActions: false }),
