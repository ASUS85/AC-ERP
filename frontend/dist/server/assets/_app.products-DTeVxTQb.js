...
import { S as StatCard, a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-BO9olZIU.js";
import { D as DataTable } from "./DataTable-BBLHBa-6.js";
import { S as StatusBadge } from "./StatusBadge-DzwZoZIv.js";
import { A as AppModal } from "./AppModal-pcG-CRmf.js";
import { B as Button, I as Input } from "./input-Cd6riMgS.js";
import { L as Label } from "./label-CxdS1iA0.js";
import { T as Textarea } from "./textarea-Dxy7p_oR.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BjY7Bi5d.js";
import { toast } from "sonner";
import { f as fmtCurrency, d as fmtNumber } from "./erp-data-C0zPHDd1.js";
import { g as getCategories } from "./categories.service-BhRtDEv_.js";
...
function ProductsPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editingProduct ? "Modifier un produit" : "Ajouter un produit", description: "Renseignez les informations du catalogue.", size: "xl", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Field, { label: "Catégorie", htmlFor: "categorie", error: errors.idCategorie, children: /* @__PURE__ */ jsx(SearchableSelect, { value: form.idCategorie, onValueChange: (value) => setField("idCategorie", value), placeholder: "Sélectionner une catégorie", searchPlaceholder: "Rechercher une catégorie...", emptyMessage: "Aucune catégorie trouvée", options: categories.map((cat) => ({
        value: cat.id,
        label: cat.nom
      })) }) }),
      ...
      /* @__PURE__ */ jsx(Field, { label: "Prix d’achat HT", htmlFor: "prixAchatHt", error: errors.prixAchatHt, children: /* @__PURE__ */ jsx(Input, { id: "prixAchatHt", type: "number", min: "0", value: form.prixAchatHt, onChange: (e) => setField("prixAchatHt", Number(e.target.value)), placeholder: "Entrez un prix de d'achat" }) }),
      /* @__PURE__ */ jsx(Field, { label: "Prix de vente HT", htmlFor: "prixVenteHt", error: errors.prixVenteHt, children: /* @__PURE__ */ jsx(Input, { id: "prixVenteHt", type: "number", min: "0", value: form.prixVenteHt, onChange: (e) => setField("prixVenteHt", Number(e.target.value)), placeholder: "Entrez un prix de vente" }) }),
      /* @__PURE__ */ jsx(Field, { label: "Taux TVA (%)", htmlFor: "tauxTva", error: errors.tauxTva, children: /* @__PURE__ */ jsx(Input, { id: "tauxTva", type: "number", min: "0", value: form.tauxTva, onChange: (e) => setField("tauxTva", Number(e.target.value)), placeholder: "Entrez la TVA(%)" }) }),
      /* @__PURE__ */ jsx(Field, { label: "Stock minimum", htmlFor: "stockMinimum", error: errors.stockMinimum, children: /* @__PURE__ */ jsx(Input, { id: "stockMinimum", type: "number", min: "0", value: form.stockMinimum, onChange: (e) => setField("stockMinimum", Number(e.target.value)), placeholder: "Entrez le stock minimum" }) }),
      !editingProduct ? /* @__PURE__ */ jsx(Field, { label: "Stock initial", htmlFor: "stockInitial", error: errors.stockInitial, children: /* @__PURE__ */ jsx(Input, { id: "stockInitial", type: "number", min: "0", value: form.stockInitial, onChange: (e) => setField("stockInitial", Number(e.target.value)), placeholder: "Entrez le stock initial" }) }) : null,
