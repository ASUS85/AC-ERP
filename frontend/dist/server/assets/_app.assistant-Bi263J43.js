...
import { c as cn, e as getStoredUser } from "./router-B5GAJ1jr.js";
import { a as getConversations, b as getConversationMessages, s as sendChat, r as renameConversation, d as deleteConversation } from "./ia.service-BXOJWiSI.js";
import { l as logo } from "./erp-logo-C4ESMtut.js";
import { toast } from "sonner";
import { r as resolveAvatarUrl } from "./avatar-Abbf1WZy.js";
import { A as Avatar, a as AvatarImage, b as AvatarFallback } from "./avatar-DrxRsotV.js";
import { S as Skeleton } from "./skeleton-DCOpnToG.js";
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, e as DropdownMenuItem, d as DropdownMenuSeparator } from "./dropdown-menu-BWhuKXK1.js";
      ...
      /* @__PURE__ */ jsx("div", { className: "h-[68vh] min-h-0 lg:col-span-3 lg:h-full", children: /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col rounded-sm border border-border bg-card shadow-card", children: [
        /* @__PURE__ */ jsxs("div", { className: "min-h-0 flex-1 space-y-5 overflow-y-auto p-5", children: [
          messages.map((m, i) => /* @__PURE__ */ jsxs("div", { className: cn("flex animate-in fade-in-0 slide-in-from-bottom-2 gap-3 duration-300", m.role === "user" && "flex-row-reverse"), children: [
            ...
            /* @__PURE__ */ jsx("div", { className: cn("max-w-[82%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed", m.role === "ai" ? "bg-secondary text-foreground" : "bg-primary text-primary-foreground whitespace-pre-wrap"), children: m.role === "ai" ? /* @__PURE__ */ jsx(ReactMarkdown, { remarkPlugins: [remarkGfm], components: {
              // Tableaux
              table: ({
                children
              }) => /* @__PURE__ */ jsx("div", { className: "my-2 overflow-x-auto rounded-lg border border-border", children: /* @__PURE__ */ jsx("table", { className: "w-full text-sm", children }) }),
              thead: ({
                children
              }) => /* @__PURE__ */ jsx("thead", { className: "bg-muted/60 text-xs uppercase text-muted-foreground", children }),
              tbody: ({
                children
              }) => /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-border", children }),
              tr: ({
                children
              }) => /* @__PURE__ */ jsx("tr", { className: "transition-colors hover:bg-muted/30", children }),
              th: ({
                children
              }) => /* @__PURE__ */ jsx("th", { className: "px-3 py-2 text-left font-semibold", children }),
              td: ({
                children
              }) => /* @__PURE__ */ jsx("td", { className: "px-3 py-2", children }),
              // Blocs de code
              code: ({
                inline,
                children,
                ...props
              }) => inline ? /* @__PURE__ */ jsx("code", { className: "rounded bg-background/80 px-1.5 py-0.5 font-mono text-xs text-primary", ...props, children }) : /* @__PURE__ */ jsx("pre", { className: "my-2 overflow-x-auto rounded-lg bg-background/80 p-3", children: /* @__PURE__ */ jsx("code", { className: "font-mono text-xs text-foreground", ...props, children }) }),
              // Titres
              h2: ({
                children
              }) => /* @__PURE__ */ jsx("h2", { className: "mb-2 mt-3 text-sm font-bold text-foreground first:mt-0", children }),
              h3: ({
                children
              }) => /* @__PURE__ */ jsx("h3", { className: "mb-1 mt-2 text-xs font-bold uppercase tracking-wide text-muted-foreground first:mt-0", children }),
              // Listes
              ul: ({
                children
              }) => /* @__PURE__ */ jsx("ul", { className: "my-1.5 space-y-1 pl-4", children }),
              ol: ({
                children
              }) => /* @__PURE__ */ jsx("ol", { className: "my-1.5 list-decimal space-y-1 pl-4", children }),
              li: ({
                children
              }) => /* @__PURE__ */ jsx("li", { className: "text-sm leading-relaxed", children }),
              // Gras
              strong: ({
                children
              }) => /* @__PURE__ */ jsx("strong", { className: "font-semibold text-foreground", children }),
              // Paragraphes
              p: ({
                children
              }) => /* @__PURE__ */ jsx("p", { className: "mb-1.5 leading-relaxed last:mb-0", children })
            }, children: m.text }) : m.text })
          ] }, i)),
