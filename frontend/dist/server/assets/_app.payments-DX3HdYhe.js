...
import { S as StatCard, a as SectionCard, b as SearchableSelect, P as Pagination } from "./widgets-42npvNwp.js";
...
import { g as getPaiements } from "./paiements.service-BM9kv6MX.js";
...
function PaymentsPage() {
  ...
  const cols = useMemo(() => [{
    ...
    header: "Montant",
    align: "right",
    render: (p) => /* @__PURE__ */ jsxs("span", { className: "font-medium text-success", children: [
      "+ ",
    ...
    /* @__PURE__ */ jsx(AppModal, { open: detailOpen, onOpenChange: setDetailOpen, title: "Détail du paiement", description: "Informations relatives au paiement sélectionné", size: "xl", footer: /* @__PURE__ */ jsx("div", { className: "flex justify-end w-full", children: /* @__PURE__ */ jsx(Button, { variant: "outline", onClick: () => setDetailOpen(false), children: "Fermer" }) }), children: selectedPayment ? /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-card p-4 shadow-sm md:col-span-1", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-muted-foreground mb-1", children: "Montant Encaissé" }),
          /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-success", children: fmtCurrency(Number(selectedPayment.montant)) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-border bg-card p-4 shadow-sm md:col-span-2 flex flex-col justify-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-2 text-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-1 border-b border-border/50", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-semibold uppercase text-primary bg-primary/10 px-2 py-0.5 rounded-md", children: selectedPayment.modePaiement })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center py-1 border-b border-border/50", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-2 text-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 py-1 border-b border-border/50 pb-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-xs uppercase", children: "Client concerné" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: selectedPayment.facture?.client?.nom || "Client occasionnel" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 py-1 border-b border-border/50 pb-2", children: [
