...
import { I as Input, B as Button } from "./input-AeiaPT4J.js";
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, e as DropdownMenuItem } from "./dropdown-menu-CEa0MGsQ.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      filterOptions && onFilterChange ? /* @__PURE__ */ jsxs(DropdownMenu, { children: [
        ...
        /* @__PURE__ */ jsx(DropdownMenuContent, { align: "end", className: "min-w-[180px]", children: filterOptions.map((option) => /* @__PURE__ */ jsx(DropdownMenuItem, { onClick: () => onFilterChange(option.value), children: option.label }, option.value)) })
...
function Pagination({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-between gap-3 pt-4 sm:flex-row", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", disabled: currentPage <= 1, onClick: () => onPageChange?.(currentPage - 1), children: "Précédent" }),
      ...
      /* @__PURE__ */ jsx(Button, { variant: "outline", size: "sm", disabled: currentPage >= total, onClick: () => onPageChange?.(currentPage + 1), children: "Suivant" })
    ] })
  ] });
}
export {
