...
import { ArrowDownToLine, ClipboardList, Warehouse, ArrowUpFromLine, AlertTriangle, Loader2, RefreshCw, CheckCircle2, Ban, Save, XCircle, AlertCircle } from "lucide-react";
...
import { B as Button, I as Input } from "./input-DWqQzZ0E.js";
  ...
  const loadAll = useCallback(async (force = false) => {
    ...
    try {
      const [skRes, mvRes, alRes, invRes, prodRes] = await Promise.allSettled([getStocks({
        ...
        const {
          default: api2
        } = await import("./router-DPN3mKuc.js").then((n) => n.q);
