...
import { a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-D7zUdX-c.js";
...
import { i as api, c as cn } from "./router-Dmoktl13.js";
import { g as getFournisseurs } from "./fournisseurs.service-BgjCZjeB.js";
import { g as getProduits } from "./produits.service-CYzplwQX.js";
...
function PurchasesPage() {
  ...
  const actionsByStatus = (row) => {
    ...
    if (row.statutRaw === "RECU_PARTIEL") {
      return [
        makeAction("create-invoice", "Creer facture achat", /* @__PURE__ */ jsx(FileEdit, { className: "mr-2 h-4 w-4" }), () => createSupplierInvoice(row.id)),
