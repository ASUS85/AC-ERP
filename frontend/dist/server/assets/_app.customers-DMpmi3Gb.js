...
import { v as customers, f as fmtCurrency } from "./erp-data-CgsBYils.js";
...
function CustomersPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsx(StatCard, { label: "Encours total", value: "48 200 €", sub: "à recouvrer", icon: /* @__PURE__ */ jsx(Wallet, { className: "h-5 w-5" }) }),
