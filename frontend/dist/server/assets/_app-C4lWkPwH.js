...
import { ChevronRight, ChevronLeft, Menu, Search, Bell, Settings, ChevronDown, LogOut, X } from "lucide-react";
import { n as navGroups } from "./erp-data-Byxy0z8s.js";
import { c as cn, g as getStoredUser, e as getRoleName$1, d as canAccessPermission, A as AUTH_STORAGE_KEYS, h as logout, u as useGlobalLoader, G as GlobalLoaderSlot } from "./router-qTiJlct9.js";
import { l as logo } from "./erp-logo-C4ESMtut.js";
import * as TooltipPrimitive from "@radix-ui/react-tooltip";
import { b as buttonVariants, B as Button, I as Input } from "./input-CXzFZCFy.js";
import * as AlertDialogPrimitive from "@radix-ui/react-alert-dialog";
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuLabel, d as DropdownMenuSeparator, e as DropdownMenuItem } from "./dropdown-menu-Cn6t4MSj.js";
import { A as Avatar, a as AvatarImage, r as resolveAvatarUrl, b as AvatarFallback, g as getEntreprise } from "./parametres.service-DBJDpkI4.js";
import { io } from "socket.io-client";
import { m as marquerLue, g as getNotifications } from "./notifications.service-CcQtu0QA.js";
            ...
            const link = /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  item.badge && !collapsed ? /* @__PURE__ */ jsx(
                    "span",
                    {
                      className: cn(
              ...
              /* @__PURE__ */ jsx(
                TooltipContent,
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "space-y-0.5", children: [
                    ...
                    item.badge ? /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-sidebar-foreground/50", children: [
                      "Badge: ",
                      item.badge
                    ] }) : null
                  ] })
...
const NOTIFICATIONS_SYNC_INTERVAL_MS = 15e3;
...
function AppLayout() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full bg-background", children: [
    /* @__PURE__ */ jsx("aside", { className: cn("fixed inset-y-0 left-0 z-40 hidden transition-[width] duration-200 lg:block", sidebarCollapsed ? "w-20" : "w-64"), children: /* @__PURE__ */ jsx(SidebarNav, { collapsed: sidebarCollapsed, onToggleCollapsed: toggleSidebarCollapsed }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: cn("flex min-h-screen flex-col transition-[padding-left] duration-200", sidebarCollapsed ? "lg:pl-20" : "lg:pl-64"), children: [
