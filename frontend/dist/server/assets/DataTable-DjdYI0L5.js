...
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, e as DropdownMenuItem } from "./dropdown-menu-Cn6t4MSj.js";
function DataTable({
  columns,
  rows,
  rowKey,
      ...
      rows.map((row) => /* @__PURE__ */ jsxs(
        "tr",
        {
          ...
          children: [
            ...
            withActions && /* @__PURE__ */ jsx("td", { className: "px-3 py-1 text-right", children: rowActions ? /* @__PURE__ */ jsxs(DropdownMenu, { children: [
              ...
              /* @__PURE__ */ jsx(DropdownMenuContent, { align: "end", className: "min-w-40", children: rowActions(row).map((action) => {
                const isBusy = isRowActionLoading?.(row) ?? false;
