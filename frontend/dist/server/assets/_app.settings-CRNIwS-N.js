...
import { LoaderCircle, User, Building2, SlidersHorizontal, Shield, ScrollText, Camera, DatabaseBackup, Clock, Calendar, MonitorSmartphone, Bot, LineChart, BarChart3, Bell, CreditCard, FileText, ShoppingBag, ShoppingCart, Warehouse, Factory, Users, FolderOpen, Package, KeyRound, Lock, ChevronDown } from "lucide-react";
import { P as PageHeader } from "./PageHeader-D6EtHCBB.js";
import { a as SectionCard, b as SearchableSelect } from "./widgets-BODimdeo.js";
import { A as AppModal } from "./AppModal-CzTwj6St.js";
import { i as api, j as useGlobalLoader, u as useAuthStore, k as uploadAvatar, m as updateProfile, n as changePassword, o as revokeOtherSessions, c as cn } from "./router-DmDzdhp9.js";
...
import { S as Switch } from "./switch-B5K1wlNM.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DNFJOUNF.js";
import { u as useAuth } from "./useAuth-BdOTPKME.js";
import { u as useSettingsStore, g as getJournal, a as updateEntreprise, b as updateMaintenance, c as updateSysteme, d as getSysteme } from "./settings.store-Ds3unlDt.js";
import { A as AFRICAN_CURRENCIES, a as getCurrencyMeta, s as setStoredCurrency } from "./currency-BmQmAj7J.js";
...
const listBackups = () => api.get("/backup");
const createBackup = () => api.post("/backup", {}, { timeout: 12e4 });
const restoreBackup = (filename) => api.post(
...
function fmtBackupDateTime(value) {
...
function AuditRow({
  ...
  const formatDateTime = (value) => {
    ...
    const time2 = new Intl.DateTimeFormat("fr-FR", {
      hour: "2-digit",
      minute: "2-digit"
    }).format(date2);
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("group relative rounded-2xl border border-border/70 bg-card/80 px-5 py-4 backdrop-blur-sm transition-all hover:border-primary/30 hover:shadow-md", "hover:border-primary/30 hover:shadow-sm", expanded && "border-primary/50 shadow-sm", hasDetails && "cursor-pointer"), onClick: () => hasDetails && setExpanded((v) => !v), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 flex-col items-end gap-0.5", children: [
        /* @__PURE__ */ jsx("span", { className: "tabular-nums text-xs text-muted-foreground", children: /* @__PURE__ */ jsxs("div", { className: "inline-flex flex-col items-end gap-0.5 rounded-md border border-border/40 bg-muted/30 px-2.5 py-1 text-xs", children: [
...
function SettingsPage() {
  ...
  profile?.role?.nomRole === "SUPER_ADMIN" || "ADMIN";
  const canManageBackups = hasPermission("users", "supprimer");
  useEffect(() => {
    let alive = true;
    async function loadInitialData() {
      const [meResult, sessionsResult, entrepriseResult, systemeResult] = await Promise.allSettled([fetchProfile(), fetchSessions(), canManageSettings ? fetchEntreprise() : Promise.resolve(null), canManageSettings ? fetchSysteme() : Promise.resolve(null)]);
      if (!alive) return;
  ...
  }, [canManageSettings, fetchEntreprise, fetchProfile, fetchSessions, fetchSysteme]);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    listBackups().then((r) => setBackups(unwrap(r) || [])).catch(() => toast.error("Impossible de charger les sauvegardes"));
  }, [canManageBackups]);
  useEffect(() => {
    return () => {
  ...
  const toggleSystem = async (field, value) => {
    ...
    try {
      ...
      const updatedSystem = unwrap(response);
    ...
    try {
      ...
      if (!sys?.modeMaintenance) {
        toast.warning("Mode maintenance requis", {
          description: "La restauration nécessite que le système soit préalablement placé en mode maintenance. Activez-le dans les paramètres système avant de restaurer les données."
        });
        return;
      }
    } catch {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Tabs, { defaultValue: "profile", children: [
      ...
      canManageSettings ? /* @__PURE__ */ jsx(TabsContent, { value: "company", children: /* @__PURE__ */ jsxs(SectionCard, { title: "Paramètres entreprise", description: "Informations utilisées sur les documents et rapports", children: [
        company && /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsx(Field, { label: "Lien plateforme d'échange", value: company.lienPlateformeEchange || "", placeholder: "https://chat.whatsapp.com/... ou https://t.me/...", onChange: (v) => updateCompanyField("lienPlateformeEchange", v) })
        ] }),
        /* @__PURE__ */ jsx(Button, { className: "mt-4", onClick: saveCompany, children: "Enregistrer" })
      ] }) }) : null,
      canManageSettings ? /* @__PURE__ */ jsx(TabsContent, { value: "system", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-4", children: [
        /* @__PURE__ */ jsx(SectionCard, { title: "Paramètres système", description: "Préférences globales de la plateforme", children: system && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsx(Setting, { label: "Mode maintenance", description: "Bloque les écritures pour tous sauf le super administrateur", checked: system.modeMaintenance, disabled: false, onChange: (v) => toggleSystem("modeMaintenance", v) })
        ] }) }),
        canManageBackups ? /* @__PURE__ */ jsxs(SectionCard, { title: "Synchronisation", description: "Sauvegardes de la base de données", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-lg bg-secondary/50 p-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Sauvegarde automatique chaque nuit à 2h00" })
            ] })
          ] }),
          backups.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-3 max-h-52 space-y-2 overflow-y-auto pr-1", children: backups.slice(0, 5).map((backup) => {
            const {
              time,
              date
            } = fmtBackupDateTime(backup.createdAt);
            return /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setSelectedBackup(backup), className: "flex w-full cursor-pointer items-center justify-between gap-3 rounded-lg border border-border/70 bg-background p-3 text-left transition-colors hover:border-primary/40 hover:bg-muted/30", children: [
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "truncate font-mono text-xs text-muted-foreground", children: backup.filename }),
                /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-muted-foreground/70", children: [
                  backup.sizeKb,
                  " Ko"
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "inline-flex shrink-0 flex-col items-end gap-0.5 rounded-md border border-border/40 bg-muted/30 px-2.5 py-1 text-xs", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 font-semibold text-foreground/80", children: [
                  /* @__PURE__ */ jsx(Clock, { className: "h-3 w-3 text-muted-foreground" }),
                  /* @__PURE__ */ jsx("span", { children: time })
                ] }),
          ...
          /* @__PURE__ */ jsx(Button, { className: "mt-4 w-full", onClick: handleCreateBackup, disabled: creatingBackup, children: creatingBackup ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }),
            "Sauvegarde en cours..."
          ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(DatabaseBackup, { className: "mr-2 h-4 w-4" }),
    ...
    /* @__PURE__ */ jsx(AppModal, { open: Boolean(selectedBackup), onOpenChange: (open) => {
      if (!open && !restoring) setSelectedBackup(null);
    }, title: "Détails de la sauvegarde", description: "Consultation d'une sauvegarde", size: "lg", footer: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
      /* @__PURE__ */ jsx(Button, { variant: "outline", disabled: restoring, onClick: () => setSelectedBackup(null), children: "Fermer" }),
      /* @__PURE__ */ jsx(Button, { onClick: handleRestore, disabled: restoring, children: restoring ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }),
    ...
    ] }), children: selectedBackup && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-lg border bg-background p-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "Fichier" }),
          /* @__PURE__ */ jsx("span", { className: "max-w-[60%] truncate font-mono text-xs font-medium", children: selectedBackup.filename })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-lg border bg-background p-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "Date" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: fmtBackupDateTime(selectedBackup.createdAt).date })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-lg border bg-background p-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "Heure" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: fmtBackupDateTime(selectedBackup.createdAt).time })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-lg border bg-background p-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "Taille" }),
          /* @__PURE__ */ jsxs("span", { className: "text-sm font-medium", children: [
            selectedBackup.sizeKb,
            " Ko"
          ] })
        ] })
      ] }),
      !system?.modeMaintenance && /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-amber-300 bg-amber-50 p-3 text-xs text-amber-800 dark:border-amber-500/40 dark:bg-amber-900/20 dark:text-amber-300", children: "Le mode maintenance doit être activé avant toute restauration. Activez-le dans les paramètres système ci-dessus." }),
      restoring && /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-primary/30 bg-primary/5 p-3 text-xs text-foreground", children: "Restauration en cours… Veuillez patienter et ne pas fermer cette page pendant l'opération." })
    ] }) })
  ] });
}
