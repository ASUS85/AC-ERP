...
import { S as StatCard, a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-DrjmuOnd.js";
import { D as DataTable } from "./DataTable-EN711mBB.js";
import { S as StatusBadge } from "./StatusBadge-CEiupKeU.js";
import { A as AppModal } from "./AppModal-BJ8RFKpw.js";
import { B as Button } from "./button-BnXidLRr.js";
import { I as Input } from "./input-Dll8ozDh.js";
import { L as Label } from "./label-C2EMg7Zu.js";
import { T as Textarea } from "./textarea-C1FoCsEd.js";
...
import { g as getCategories } from "./categories.service-Dg_tbEAr.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editingProduct ? "Modifier un produit" : "Ajouter un produit", description: "Renseignez les informations du catalogue.", size: "xl", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsxs(Field, { label: "Unité", htmlFor: "uniteMesure", error: errors.uniteMesure, children: [
        /* @__PURE__ */ jsx("span", { class: "ml-1 text-destructive", children: "*" }),
        /* @__PURE__ */ jsxs(Select, { value: form.uniteMesure, onValueChange: (value) => setField("uniteMesure", value), children: [
