...
import { S as StatCard, a as SectionCard, T as Toolbar, P as Pagination, b as SearchableSelect } from "./widgets-dh2l9GK9.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-CQ5sryN1.js";
import { toast } from "sonner";
import { f as fmtCurrency, c as fmtNumber } from "./erp-data-C8LoOZfP.js";
import { g as getCategories } from "./categories.service-CjrvEM7w.js";
import { g as getProduits, a as getProduitsPdf, u as updateProduit, c as createProduit, b as archiveProduit } from "./produits.service-iBkX0YUV.js";
import "@tanstack/react-router";
import "./router-soiu03Zn.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editingProduct ? "Modifier un produit" : "Ajouter un produit", description: "Renseignez les informations du catalogue.", size: "xl", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsxs(Field, { label: "Prix de vente HT", htmlFor: "prixVenteHt", error: errors.prixVenteHt, children: [
        /* @__PURE__ */ jsx("span", { class: "ml-1 text-destructive", children: "*" }),
        /* @__PURE__ */ jsx(Input, { id: "prixVenteHt", type: "number", min: "0", value: form.prixVenteHt, onChange: (e) => setField("prixVenteHt", Number(e.target.value)), placeholder: "Entrez un prix de vente" })
      ] }),
      /* @__PURE__ */ jsxs(Field, { label: "Taux TVA (%)", htmlFor: "tauxTva", error: errors.tauxTva, children: [
        /* @__PURE__ */ jsx("span", { class: "ml-1 text-destructive", children: "*" }),
        /* @__PURE__ */ jsx(Input, { id: "tauxTva", type: "number", min: "0", value: form.tauxTva, onChange: (e) => setField("tauxTva", Number(e.target.value)), placeholder: "Entrez la TVA(%)" })
      ] }),
      /* @__PURE__ */ jsxs(Field, { label: "Stock minimum", htmlFor: "stockMinimum", error: errors.stockMinimum, children: [
        /* @__PURE__ */ jsx("span", { class: "ml-1 text-destructive", children: "*" }),
        /* @__PURE__ */ jsx(Input, { id: "stockMinimum", type: "number", min: "0", value: form.stockMinimum, onChange: (e) => setField("stockMinimum", Number(e.target.value)), placeholder: "Entrez le stock minimum" })
      ] }),
