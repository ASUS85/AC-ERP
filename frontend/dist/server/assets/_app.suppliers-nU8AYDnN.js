...
function SuppliersPage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(AppModal, { open: modalOpen, onOpenChange: setModalOpen, title: editing ? "Modifier un fournisseur" : "Ajouter un fournisseur", description: "Renseignez les coordonnées du fournisseur.", size: "xl", footer: /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Field, { label: "Raison sociale", htmlFor: "raisonSociale", error: errors.raisonSociale, children: /* @__PURE__ */ jsx(Input, { id: "raisonSociale", value: form.raisonSociale, onChange: (e) => setField("raisonSociale", e.target.value), placeholder: "Nom de l'entreprise" }) }),
      /* @__PURE__ */ jsx(Field, { label: "Email", htmlFor: "email", error: errors.email, children: /* @__PURE__ */ jsx(Input, { id: "email", type: "email", value: form.email, onChange: (e) => setField("email", e.target.value), placeholder: "contact@fournisseur.com" }) }),
      /* @__PURE__ */ jsx(Field, { label: "Telephone", htmlFor: "telephone", error: errors.telephone, children: /* @__PURE__ */ jsx(Input, { id: "telephone", value: form.telephone, onChange: (e) => setField("telephone", e.target.value), placeholder: "+237 6XX XXX XXX" }) }),
