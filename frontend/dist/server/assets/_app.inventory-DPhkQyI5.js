...
import { S as StatCard, a as SectionCard, T as Toolbar } from "./widgets-Cox8fFgr.js";
import { D as DataTable } from "./DataTable-DyNXzAjJ.js";
import { S as StatusBadge } from "./StatusBadge-DlT8mfWJ.js";
import { B as Button, c as cn } from "./input-DooCX65b.js";
import { q as stockMovements, p as products } from "./erp-data-CMZQ6Smj.js";
...
function InventoryPage() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsx(StatCard, { label: "Valeur du stock", value: "512 300 €", delta: "-2,8 %", sub: "vs mois dernier", icon: /* @__PURE__ */ jsx(Warehouse, { className: "h-5 w-5" }) }),
