...
import { S as StatCard, a as SectionCard } from "./widgets-TR90zn21.js";
import { S as StatusBadge } from "./StatusBadge-Dz4xfF4y.js";
import { B as Button } from "./input-Bxvgloed.js";
import { k as kpis, s as salesTrend, a as stockSplit, t as topProducts, b as alerts, r as recentSales, f as fmtCurrency } from "./erp-data-DbNh89rB.js";
import "react";
import "./router-DKXtA4iJ.js";
...
function Dashboard() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(PageHeader, { title: "Tableau de bord", description: "Vue décisionnelle de votre activité commerciale — Juin 2026", actions: /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6", children: kpis.map((k) => /* @__PURE__ */ jsx(StatCard, { ...k, icon: kpiIcons[k.icon] }, k.label)) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(SectionCard, { title: "Dernières ventes", description: "Activité récente", action: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/sales", children: "Tout voir" }) }), children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { children: recentSales.map((s) => /* @__PURE__ */ jsxs("tr", { className: "border-b border-border/60 last:border-0 hover:bg-secondary/40", children: [
